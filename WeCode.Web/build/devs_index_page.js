...
var DevsService = /** @class */function () {
    ...
    DevsService.prototype.getDevs = function () {
        return _axios2.default.get('api/devs');
    };
    DevsService.prototype.update = function (dev) {
        return _axios2.default.post('api/devs/save', {
            body: dev
        });
    };
    return DevsService;
}();
exports.DevsService = DevsService;
...
exports.DevsIndexPage = undefined;

var _devs = __webpack_require__(30);

var DevsIndexPage = /** @class */function () {
    function DevsIndexPage() {
        var _this = this;
        console.log("Devs index");
        var devsService = new _devs.DevsService();
        devsService.getDevs().then(function (response) {
...
exports.DevsIndexPage = DevsIndexPage;
